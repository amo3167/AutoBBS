...
This document provides instructions for building the `AsirikuyFrameworkAPI` shared library on macOS.
...
After a successful build, the main library files will be located at:

- **Debug:** `bin/gmake/x64/Debug/libAsirikuyFrameworkAPI.dylib`
- **Release:** `bin/gmake/x64/Release/libAsirikuyFrameworkAPI.dylib`

**Note:** The library is built directly in the `bin/gmake/x64/Debug/` directory (not in a `lib/` subdirectory).
...
| **File Size** | ~371KB | ~350KB (estimated) |
