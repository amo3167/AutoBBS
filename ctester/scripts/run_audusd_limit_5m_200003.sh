#!/bin/bash
# Script to run AUDUSD Limit 5M 200003 Strategy
# Cleans ctester folder and saves results to tmp folder with renamed files
#
# Usage: ./run_audusd_limit_5m_200003.sh [OPTIONS]
# Options:
...
# Configuration
CONFIG_FILE="config/Limit_AUDUSD-5M_200003.config"
SYMBOL="AUDUSD"
STRATEGY_ID="200003"
OUTPUT_DIR="tmp"
...
echo "=== Running ${SYMBOL} Limit 5M Strategy ${STRATEGY_ID} ==="
echo ""
