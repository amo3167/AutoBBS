#!/bin/bash
# Script to run BTCUSD MACD 860013 Strategy
# Cleans ctester folder and saves results to tmp folder with renamed files
#
# Usage: ./run_btcusd_macd_860013.sh [OPTIONS]
# Options:
...
# Configuration
CONFIG_FILE="config/Peso_MACD_BTCUSD-1H_860013.config"
SYMBOL="BTCUSD"
STRATEGY_ID="860013"
OUTPUT_DIR="tmp"
...
echo "=== Running ${SYMBOL} MACD Strategy ${STRATEGY_ID} ==="
echo ""
