...
2. ✅ **Build TradingStrategies without vendors** - All dependencies are in `dev/` directory
...
- All `dev/*/premake4.lua` - Removed `vpaths`, replaced `uses` with `links`
- `dev/NTPClient/premake4.lua` - Fixed corrupted file
