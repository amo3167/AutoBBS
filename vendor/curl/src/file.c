...
static CURLcode file_do(struct connectdata *, int *done);
static CURLcode file_done(struct connectdata *conn,
                          CURLcode status, int premature);
static CURLcode file_connect(struct connectdata *conn, int *done);
 ...
 * function.
 */
static CURLcode file_do(struct connectdata *conn, int *done)
{
