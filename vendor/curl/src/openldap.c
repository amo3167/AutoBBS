...
static CURLcode ldap_do(struct connectdata *conn, int *done);
static CURLcode ldap_done(struct connectdata *conn, CURLcode, int);
static CURLcode ldap_connect(struct connectdata *conn, int *done);
static CURLcode ldap_connecting(struct connectdata *conn, int *done);
static CURLcode ldap_disconnect(struct connectdata *conn, int dead);
...
static CURLcode ldap_disconnect(struct connectdata *conn, int dead_connection)
{
  ldapconninfo *li = conn->proto.generic;
