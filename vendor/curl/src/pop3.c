...
/* Local API functions */
static CURLcode pop3_regular_transfer(struct connectdata *conn, int *done);
static CURLcode pop3_do(struct connectdata *conn, int *done);
static CURLcode pop3_done(struct connectdata *conn, CURLcode status,
                          int premature);
static CURLcode pop3_connect(struct connectdata *conn, int *done);
static CURLcode pop3_disconnect(struct connectdata *conn, int dead);
static CURLcode pop3_multi_statemach(struct connectdata *conn, int *done);
static int pop3_getsock(struct connectdata *conn, curl_socket_t *socks,
                        int numsocks);
static CURLcode pop3_doing(struct connectdata *conn, int *dophase_done);
 ...
 */
static int pop3_endofresp(struct connectdata *conn, char *line, size_t len,
                           int *resp)
{
 ...
 */
static CURLcode pop3_perform(struct connectdata *conn, int *connected,
                             int *dophase_done)
{
...
static CURLcode pop3_dophase_done(struct connectdata *conn, int connected)
{
  (void)conn;
  (void)connected;
