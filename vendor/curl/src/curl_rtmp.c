...
static CURLcode rtmp_do(struct connectdata *conn, int *done);
static CURLcode rtmp_done(struct connectdata *conn, CURLcode, int premature);
static CURLcode rtmp_connect(struct connectdata *conn, int *done);
static CURLcode rtmp_disconnect(struct connectdata *conn, int dead);
