...
static CURLcode tftp_connect(struct connectdata *conn, int *done);
static CURLcode tftp_disconnect(struct connectdata *conn,
                                int dead_connection);
static CURLcode tftp_do(struct connectdata *conn, int *done);
static CURLcode tftp_done(struct connectdata *conn,
                          CURLcode, int premature);
static CURLcode tftp_setup_connection(struct connectdata * conn);
static CURLcode tftp_multi_statemach(struct connectdata *conn, int *done);
static CURLcode tftp_doing(struct connectdata *conn, int *dophase_done);
...
static CURLcode tftp_set_timeouts(tftp_state_data_t *state)
{
  ...
  long timeout_ms;
  int start = (state->state == TFTP_STATE_START) ? TRUE : FALSE;
 ...
 *
 **********************************************************/
static CURLcode tftp_disconnect(struct connectdata *conn, int dead_connection)
{
 ...
 *
 **********************************************************/
static CURLcode tftp_perform(struct connectdata *conn, int *dophase_done)
{
  CURLcode              result = CURLE_OK;
  tftp_state_data_t     *state = (tftp_state_data_t *)conn->proto.tftpc;
