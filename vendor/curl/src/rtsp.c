...
static CURLcode rtsp_do(struct connectdata *conn, int *done);
static CURLcode rtsp_done(struct connectdata *conn, CURLcode, int premature);
static CURLcode rtsp_connect(struct connectdata *conn, int *done);
static CURLcode rtsp_disconnect(struct connectdata *conn, int dead);
 ...
 */
int Curl_rtsp_connisdead(struct connectdata *check)
{
  int sval;
  int ret_val = TRUE;
