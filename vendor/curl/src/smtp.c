...
/* Local API functions */
static CURLcode smtp_regular_transfer(struct connectdata *conn, int *done);
static CURLcode smtp_do(struct connectdata *conn, int *done);
static CURLcode smtp_done(struct connectdata *conn, CURLcode status,
                          int premature);
static CURLcode smtp_connect(struct connectdata *conn, int *done);
static CURLcode smtp_disconnect(struct connectdata *conn, int dead);
static CURLcode smtp_multi_statemach(struct connectdata *conn, int *done);
static int smtp_getsock(struct connectdata *conn, curl_socket_t *socks,
                        int numsocks);
static CURLcode smtp_doing(struct connectdata *conn, int *dophase_done);
 ...
 */
static int smtp_endofresp(struct connectdata *conn, char *line, size_t len,
                           int *resp)
{
 ...
 */
static CURLcode smtp_perform(struct connectdata *conn, int *connected,
                             int *dophase_done)
{
...
static CURLcode smtp_dophase_done(struct connectdata *conn, int connected)
{
  struct SMTP *smtp = conn->data->state.proto.smtp;
