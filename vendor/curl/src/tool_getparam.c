...
ParameterError getparameter(char *flag,    /* f or -long-flag */
                            ...
                            int *usedarg, /* set to TRUE if the arg
                                              has been used */
                            struct Configurable *config)
{
  ...
  int hit = -1;
  int longopt = FALSE;
  int singleopt = FALSE; /* when true means '-o foo' used '-ofoo' */
  ParameterError err;
  int toggle = TRUE; /* how to switch intean options, on or off. Controlled
