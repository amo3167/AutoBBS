...
//---- indicator line
   ...
   SetIndexStyle(1,DRAW_LINE,2,1,DarkBlue);
   SetIndexStyle(2,DRAW_LINE,2,1,Maroon);
   SetIndexStyle(3,DRAW_LINE,2,1,DarkBlue);
   SetIndexStyle(4,DRAW_LINE,2,1,Maroon);
   SetIndexStyle(5,DRAW_LINE,2,1,Green);
   SetIndexStyle(6,DRAW_LINE,2,1,Green);
