//+------------------------------------------------------------------+
//|                                                 FXplusÊàÖáÏß.mq4 |
//|                           Copyright  2010,FXplus Trading Academy |
//|                                                       Jack Chang |
//|                                        http://www.fxplus.com.au/ |
//+------------------------------------------------------------------+
#property copyright "FXplus Trading Academy"
#property link      "http://www.fxplus.com.au/"
...
//---- indicator line
   ...
   SetIndexStyle(1,DRAW_LINE,3,1,DarkBlue);
   SetIndexStyle(2,DRAW_LINE,3,1,Maroon);
   SetIndexStyle(3,DRAW_LINE,3,1,DarkBlue);
   SetIndexStyle(4,DRAW_LINE,3,1,Maroon);
   SetIndexStyle(5,DRAW_LINE,3,1,Green);
   SetIndexStyle(6,DRAW_LINE,3,1,Green);
