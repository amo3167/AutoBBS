...
//---- indicator line
   ...
   SetIndexStyle(1,DRAW_LINE,2,1,RoyalBlue);
   SetIndexStyle(2,DRAW_LINE,2,1,Crimson);
   SetIndexStyle(3,DRAW_LINE,2,1,RoyalBlue);
   SetIndexStyle(4,DRAW_LINE,2,1,Crimson);
   SetIndexStyle(5,DRAW_LINE,2,1,SeaGreen);
   SetIndexStyle(6,DRAW_LINE,2,1,SeaGreen);
