...
extern int    STRATEGY_TIMEFRAME    = 60;      // 1hour = 60, 4hour = 240, daily = 1440.
...
extern int    AUTOBBS_TP_MODE           = 0;   // If mode =1, the last trade will be 1:3, if 0, it will be no TP.
extern int    AUTOBBS_TREND_MODE         = 9;
extern int    AUTOBBS_RISK_CAP           = 3;
extern int    AUTOBBS_LONG_SHORT_MODE    = 0;
extern double AUTOBBS_MAX_ACCOUNT_RISK    = 3;
extern int    AUTOBBS_KEYK               = 1;
extern int    AUTOBBS_RANGE              = 1;
...
extern int    AUTOBBS_IS_AUTO_MODE       = 1;
extern double AUTOBBS_IS_ATREURO_RANGE   = 8;
...
bool initialize(double& systemSettings[][SYSTEM_SETTINGS_ARRAY_SIZE], double& strategySettings[][STRATEGY_SETTINGS_ARRAY_SIZE], charArray& strategyStrings[][STRATEGY_STRINGS_ARRAY_SIZE], double& profitDrawdown[][PROFIT_DRAWDOWN_ARRAY_SIZE], charArray& ratesSymbols[][TOTAL_RATES_ARRAYS], double& ratesInformation[][TOTAL_RATES_ARRAYS][RATES_INFO_ARRAY_SIZE])
{
  ...
  {
    StringToCharArray("AutoBBS Auto", strategyStrings [0][IDX_STRATEGY_NAME].a) ; 
  }
  ...
  else if(AUTOBBS_TREND_MODE == 27)  
  {
    StringToCharArray("Ichimoko Trading", strategyStrings [0][IDX_STRATEGY_NAME].a) ; 
  } 
  else if(AUTOBBS_TREND_MODE == 101)  
  {
    StringToCharArray("Ichimoko Trading Index", strategyStrings [0][IDX_STRATEGY_NAME].a) ; 
  } 
  else  
  ...
  strategySettings[0][IDX_ADDITIONAL_PARAM_2]    = AUTOBBS_TP_MODE;
  strategySettings[0][IDX_ADDITIONAL_PARAM_3]    = AUTOBBS_TREND_MODE;
  strategySettings[0][IDX_ADDITIONAL_PARAM_4]    = AUTOBBS_RISK_CAP;
  ...
  strategySettings[0][IDX_ADDITIONAL_PARAM_8]    = AUTOBBS_RANGE;
  ...
  strategySettings[0][IDX_ADDITIONAL_PARAM_13]   = AUTOBBS_IS_AUTO_MODE;
  strategySettings[0][IDX_ADDITIONAL_PARAM_14]   = AUTOBBS_IS_ATREURO_RANGE;
  ...
  ratesInformation[0][0][IDX_TOTAL_BARS_REQUIRED]= 240;
  ...
  ratesInformation[0][1][IDX_TOTAL_BARS_REQUIRED]= 240;
  ...
  ratesInformation[0][2][IDX_TOTAL_BARS_REQUIRED]= 240;
  ...
  ratesInformation[0][3][IDX_TOTAL_BARS_REQUIRED]= 240;
  ...
  ratesInformation[0][4][IDX_TOTAL_BARS_REQUIRED]= 50;  
  ...
  ratesInformation[0][5][IDX_TOTAL_BARS_REQUIRED]= 28; 
  ...
  ratesInformation[0][6][IDX_TOTAL_BARS_REQUIRED]= 4; 
