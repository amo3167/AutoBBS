...
extern int    STRATEGY_INSTANCE_ID  = -1;     // Unique identifier for an instance of internal strategy 1.
...
{
  StringToCharArray("Screening", strategyStrings [0][IDX_STRATEGY_NAME].a) ; 
  ...
  strategySettings[0][IDX_INTERNAL_STRATEGY_ID]  = SCREENING;
  ...
  ratesInformation[0][1][IDX_REQUIRED_TIMEFRAME] = PERIOD_H4;
  ...
  ratesInformation[0][2][IDX_REQUIRED_TIMEFRAME] = PERIOD_D1;
  ratesInformation[0][2][IDX_TOTAL_BARS_REQUIRED]= 30;  
  StringToCharArray(Symbol(), ratesSymbols[0][3].a ) ;
  ratesInformation[0][3][IDX_IS_ENABLED]         = true;
  ratesInformation[0][3][IDX_REQUIRED_TIMEFRAME] = PERIOD_W1;
  ratesInformation[0][3][IDX_TOTAL_BARS_REQUIRED]= 9;  
