...
def my_BidAsk(msg):
    if msg.field == 1:
        print '%s/%s: bid: %s' % (contractTuple[0], contractTuple[3], msg.price)
    elif msg.field == 2:
        print '%s/%s: ask: %s' % (contractTuple[0], contractTuple[3], msg.price)
...
if __name__ == '__main__':
    ...
    contractTuple = ('EUR', 'CASH', 'IDEALPRO', 'CHF', '', 0.0, '')
