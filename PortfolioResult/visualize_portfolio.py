...
class PortfolioVisualizer:
    ...
    def _load_data(self):
        ...
        file_mappings = {
            ...
            'monthly_report': 'portfolioMonthlyReport_adjusted_*.csv',
            'weekly_report': 'portfolioWeeklyReport_adjusted_*.csv',
            'daily_report': 'portfolioDailyReport_adjusted_*.csv',
            'statistics': 'portfolioStatistics_adjusted_*.csv',
            'optimize_stats': 'portfolioStatistics_optimize_adjusted.csv_*.csv',
            'baseline': 'portfolioResult_baseline.csv_*.csv'
        }
